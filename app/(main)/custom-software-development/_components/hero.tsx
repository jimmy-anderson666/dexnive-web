  ...
  return (
      ...
      <div className="max-w-screen-2xl mx-auto relative py-20 z-20">
        ...
        <p className="text-base md:w-[40%]  w-[95%] pt-4 mx-auto text-center">
          Our Custom Software Development Services are for businesses that are tired of “making it work.”
If your team relies on spreadsheets, workarounds, or tools that only almost do the job, that’s a sign that something needs to be built properly.
      ...
      <div className="relative -top-28  z-0" >
          <Image
          src={"/images/custom-app/hero.png"}
